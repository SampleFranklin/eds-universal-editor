    ...
    function carModelInfo(result) {
       ...
       function renderCards(carsToRender) {
           ...
           carsToRender.forEach(car => {
               ...
               let carPricePrefixText = car.exShowroomPrefixText;
               if (storedPrices[car.defaultVariantId] && storedPrices[car.defaultVariantId].price[location]) {
                   ...
                   price.textContent = carPricePrefixText + storedPrice;
               } else {
                   fetchPrice(car.defaultVariantId, price, car.exShowroomPrice,carPricePrefixText);
               }
        ...
        function fetchPrice(variantCode, priceElement, defaultPrice, carPricePrefixText) {
            ...
            if (storedPrices[variantCode].price[location]) {
                ...
                priceElement.textContent = carPricePrefixText + storedPrice;
                return;
            }
            ...
            .then(data => {
                if (data.error === false && data.data) {
                    ...
                    priceElement.textContent = carPricePrefixText + formattedPrice;
                } else {
